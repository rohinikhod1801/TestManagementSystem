...
class TestControllerTest {
	...
	public void testGetAllTests() {
		...
		ResponseEntity<List<Tests>> responseEntity = tests.getAllTests();
	...
	public void testGetTestById_Exists() {
		...
		ResponseEntity<Tests> responseEntity = tests.getTestById(testId);
		assertEquals(HttpStatus.OK, responseEntity.getStatusCode());
	...
	public void testUpdateTest() {
		Tests test = addTestData();
		when(testService.updateTest(test)).thenReturn(new Tests());
		ResponseEntity<Tests> responseEntity = tests.updateTest(test);
		assertEquals(HttpStatus.OK, responseEntity.getStatusCode());
	}
